...
Christmas Cards Maker is a creative tool powered by Google's Nano Banana Pro for generating beautiful Christmas cards. It features AI-powered generation with diverse styles, personalized messages, and high-quality output.

### What is this repository?

This is a curated collection of Christmas card prompts powered by Nano Banana Pro, automatically synced with our CMS and featuring a beautiful web gallery at [youmind.com/tools/christmas-cards-maker](https://youmind.com/tools/christmas-cards-maker).

## Contributing

### How do I submit a prompt?

Use our [GitHub Issue template](https://github.com/YouMind-OpenLab/awesome-christmas-card-prompts/issues/new?template=submit-prompt.yml) to submit your prompt. Fill in all required fields and wait for team review.
...
Use our [Bug Report template](https://github.com/YouMind-OpenLab/awesome-christmas-card-prompts/issues/new?template=bug-report.yml).

### How do I contact the team?

- 📧 Email: [contact@youmind.ai](mailto:contact@youmind.ai)
- 💬 [GitHub Discussions](https://github.com/YouMind-OpenLab/awesome-christmas-card-prompts/discussions)
- 🐛 [GitHub Issues](https://github.com/YouMind-OpenLab/awesome-christmas-card-prompts/issues)

---

Don't see your question? Ask in [GitHub Discussions](https://github.com/YouMind-OpenLab/awesome-christmas-card-prompts/discussions)!
